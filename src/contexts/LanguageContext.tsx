...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'resume.generationTime': '20초 정도 소요됩니다. 중간에 창을 닫거나 나가면 저장되지 않습니다.',
    'resume.generating': '생성 중... 20초 정도 소요됩니다.',
    'resume.abort': '중단하기',
  ...
  en: {
    ...
    'resume.generationTime': 'Takes about 20 seconds. Do not close this window.',
    'resume.generating': 'Generating... Takes about 20 seconds.',
    'resume.abort': 'Cancel',
